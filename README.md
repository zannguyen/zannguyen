<!--
  ...
  ║      ╚═╝   ╚═╝  ╚═╝╚══════╝    ╚══════╝╚═╝  ╚═══╝ ╚═════╝ ╚═╝╚═╝  ╚═══╝╚══════╝   ║
  ║                                                                           ║
  ║              T E T R I S   G A M E   D E V E L O P E R                   ║
  ║                                                                           ║
  ╚═══════════════════════════════════════════════════════════════════════════╝
-->
...
<!-- ═══════════════════════════════════════════════════════════════ -->
<!--              TETRIS BLOCK FALLING ANIMATION - FRAME 1        -->
<!-- ═══════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════ -->
<!--           TETRIS BLOCKS FALLING ANIMATION SEQUENCE            -->
<!-- ═══════════════════════════════════════════════════════════════ -->

<p align="center">
  <picture>
    <source media="(prefers-color-scheme: light)" srcset="https://readme-components.vercel.app/api/text/chlorpy?theme=dark&animation=blocks&font=block&text=VAN+NGUYEN&color=00FFF0" />
    <source media="(prefers-color-scheme: dark)" srcset="https://readme-components.vercel.app/api/text/chlorpy?theme=dark&animation=blocks&font=block&text=VAN+NGUYEN&color=00FFF0" />
    <img src="https://readme-components.vercel.app/api/text/chlorpy?theme=dark&animation=blocks&font=block&text=VAN+NGUYEN&color=00FFF0" alt="VAN NGUYEN" />
  </picture>
</p>

<!-- TETRIS BLOCK STAGES -->
<p align="center">
  <img src="https://api.dailyhero.id/v1/badge/text/VAN%20NGUYEN?color=00FFF0&bg=0D1117&font=block&style=neon" alt="Tetris Name" />
</p>

<!-- ═══════════════════════════════════════════════════════════════ -->
<!--                 TETRIS GRID GAME BOARD                       -->
<!-- ═══════════════════════════════════════════════════════════════ -->
...
<!--
  ...
  ║  THEME: Cyberpunk Tetris Game Developer Profile                          ║
  ║  NAME: VAN NGUYEN - Built with Tetris Blocks                            ║
